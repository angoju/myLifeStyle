                    ...
                    <div className="animate-in slide-in-from-bottom-2 fade-in">
                        {isSleep ? (
                            <div className="flex gap-1 mb-2">
                                <input type="number" value={sleepHrs} onChange={(e) => setSleepHrs(e.target.value)} placeholder="Hr" className="w-1/2 p-2 text-center rounded-lg border text-xs !bg-white !text-gray-900 !border-gray-200" />
                                <input type="number" value={sleepMins} onChange={(e) => setSleepMins(e.target.value)} placeholder="Min" className="w-1/2 p-2 text-center rounded-lg border text-xs !bg-white !text-gray-900 !border-gray-200" />
                            </div>
                        ) : (
                            <input type="number" value={inputValue} onChange={(e) => setInputValue(e.target.value)} placeholder="Mins" autoFocus className="w-full p-2 mb-2 text-center rounded-lg border text-xs !bg-white !text-gray-900 !border-gray-200" />
                        )}
                      ...
                      <div key={log.id} className="flex items-center justify-between bg-gray-50 dark:bg-slate-700/50 p-2 rounded-lg">
                          {editingLogId === log.id ? (
                              <div className="flex gap-1 w-full">
                                  {isSleep ? (
                                    <>
                                     <input type="number" value={sleepHrs} onChange={e => setSleepHrs(e.target.value)} className="w-8 p-1 text-xs border rounded !bg-white !text-gray-900 !border-gray-200" />
                                     <input type="number" value={sleepMins} onChange={e => setSleepMins(e.target.value)} className="w-8 p-1 text-xs border rounded !bg-white !text-gray-900 !border-gray-200" />
                                    </>
                                  ) : (
                                     <input type="number" value={inputValue} onChange={e => setInputValue(e.target.value)} className="flex-1 p-1 text-xs border rounded !bg-white !text-gray-900 !border-gray-200" />
                                  )}
